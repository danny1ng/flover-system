...
export const InputSelect = ({ items, onChange, name, ...props }: SelectProps) => {
  const {
    isOpen,
    selectedItem,
  ...
  return (
    <div className="relative">
      <span className="inline-block w-full rounded-md shadow-sm" {...getComboboxProps()}>
          ...
          >
            {items.map((item, index) => (
              <li
                ...
                {...getItemProps({ item: item.value as any, index })}
              >
                <span
                  className={`${
