...
import { EditIncomingGoodForm } from '../organisms/edit-product-form';
    ...
    <>
      ...
      <Layout pageTitle="Редактировать продукт">
        <div className="px-4 py-6 sm:px-0">
          {data?.product && <EditIncomingGoodForm productData={data.product} />}
        </div>
      </Layout>
    </>
  );
...
export const EditProductPage = withPageAuth({ roles: ['ADMIN', 'SELLER'] })(EditProduct);
